...
class RetailReplenishEnvironment(
    ...
    def reset(self) -> RetailReplenishObservation:
        """
        ...
        return RetailReplenishObservation(
            echoed_message="Retail Replenish environment ready!",
            message_length=0,
            done=False,
            reward=0.0,
        )

    def step(self, action: RetailReplenishAction) -> RetailReplenishObservation:  # type: ignore[override]
        """
